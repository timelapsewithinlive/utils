 ...
 * @date 2020/11/11
 */
public class MyDoubleArrayTrie<V> implements Serializable, ITrie<V> {
     ...
     * @return 兄弟节点个数
     */
    private int fetch(MyNode parent, List<MyNode> siblings) {
        if (error_ < 0) {
            return 0;
        }
     ...
     * @return 插入位置
     */
    private int insert(List<MyNode> siblings) {
        if (error_ < 0) {
            return 0;
        }
...
//            System.out.println(this);
        ...
        for (int i = 0; i < siblings.size(); i++) {
            List<MyNode> new_siblings = new ArrayList<MyNode>();
...
//                System.out.println(this);
     ...
     * @param buildFrom
     */
    public MyDoubleArrayTrie(TreeMap<String, V> buildFrom) {
        this();
    ...
    public int build(List<String> _key, int[] _length, int[] _value,
        ...
        MyNode root_node = new MyNode();
        root_node.left = 0;
        root_node.right = keySize;
        root_node.depth = 0;

        List<MyNode> siblings = new ArrayList<MyNode>();
...
//                ", value=" + Arrays.toString(value) +
     ...
     * @param processor 处理器
     */
    public void parseText(String
                                  text, com.hankcs.hanlp.collection.AhoCorasick.AhoCorasickDoubleArrayTrie.IHit<V> processor) {
